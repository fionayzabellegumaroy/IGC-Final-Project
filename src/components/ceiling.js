...
let ceilingGeometry = new PlaneGeometry(maze[0].length * CELL_SIZE, maze.length * CELL_SIZE);
...
export const ceiling = () => {
  ...
  ceilingMesh.position.set(maze[0].length * CELL_SIZE / 2, CELL_SIZE * 2, maze.length * CELL_SIZE / 2); // places ceiling at top of maze walls
